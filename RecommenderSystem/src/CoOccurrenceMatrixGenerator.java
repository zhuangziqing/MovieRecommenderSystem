...
public class CoOccurrenceMatrixGenerator {
	...
	public static class MatrixGeneratorMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
		...
		public void map(LongWritable key, Text value, Context context)
			...
			//We want to make it to -> key = movie1: movie2 value = 1
			//we want to get:  key = movie1: movie2  value = 1
	...
	public static void main(String[] args) throws Exception {
		//initial input: key = userid.  value = movie1: rating, movie2: rating....
		//final output:  key movie1:movie2 value count of two movies were watched by same person 
		//Example: movie1:movie2 \t 3
